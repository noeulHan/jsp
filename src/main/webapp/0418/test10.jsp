...
<div class="container">
	<h2>test10.jsp</h2>
	<h2>JSP From Tag 연습(service 메소드에서 처리)</h2>
<!--  -->	<form name="myForm" method="post" action="../T10">
	<form name="myForm" method="post" action="../T10_2">
	 <p>아이디 : <input type="text" name="mid"  vlaue="noeul123" autofocus/></p>
	 <p>비밀번호 : <input type="password" name="pwd" value="1234"></p>
	 <p>성명: <input type="text" name="name" value="한노을"></p>
	 <p>
	 ...
	 <%-- 
	 <p>
	 	현재 접속중인 IP : <%=request.getRemoteAddr() %>
